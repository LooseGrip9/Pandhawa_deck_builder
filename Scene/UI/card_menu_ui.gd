...
@onready var panel: Panel = $Visuals/CanvasGroup/Panel
@onready var cost: Label = $Visuals/CanvasGroup/Panel/Cost
@onready var icon: TextureRect = $Visuals/CanvasGroup/Panel/Icon
